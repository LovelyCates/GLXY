  ...
  <div class="app-container">
    ...
    <el-form label-width="120px">
      ...
      <el-form-item label="课程类别">
        <el-select v-model="courseInfo.subjectParentId" placeholder="请选择一级分类" @change="subjectLevelOneSubject">
        ...
        <el-select v-model="courseInfo.subjectId" placeholder="请选择二级分类">
          <el-option v-for="subject in subjectSecondList" :key="subject.value" :label="subject.title"
            :value="subject.id" />
        </el-select>
      </el-form-item>
      ...
      <el-form-item label="课程描述">
        <el-input v-model="courseInfo.description" placeholder="请填写课程描述" />
      </el-form-item>
...
const defaultForm = {
  ...
  lessonNum: 0,
  description: '',
  cover: process.env.OSS_PATH + '/blog/img/Q.ico',
  price: 0
}
...
export default {
  ...
  methods: {
    ...
    // 获得所有讲师
    getTeacherList() {
      courseApi.getAllTeacherList().then(
        response => {
    ...
    subjectLevelOneSubject(value) {
      ...
      this.subjectOneList.forEach(oneSubject => {
        if (oneSubject.id == value) {
          this.subjectSecondList = oneSubject.children;
